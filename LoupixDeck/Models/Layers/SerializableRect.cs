...
public struct SerializableRect(float left, float top, float right, float bottom) : IEquatable<SerializableRect>
{
    ...
    public readonly override bool Equals(object obj) => obj is SerializableRect r && Equals(r);
    public readonly bool Equals(SerializableRect other) => Left == other.Left && Top == other.Top && Right == other.Right && Bottom == other.Bottom;
